...
namespace Blackdress_Core.Controllers
{
    public class CarritoCompraController : Controller
    {
        ...
        public IActionResult CrearBoleta(string ordendecompra, string estadoconfeccion, DateTime fechasolicitud, DateTime fechaestimada, int valorcotizacion, string nombre_producto, string tallas, string color, string medidascorporales,
